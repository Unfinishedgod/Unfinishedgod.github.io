...
캐글을 하려면 처음엔 필사를 하라고 하는데, 어떻게 필사를 하는게 좋을까? 다른사람들이 작업 결과들을 공부 하는게 가장 효과적이다. 다음 그림은 Titanic에 올라온 Notebook을 확인 하는 절차를 나타냈다. 쓰던 도중 책에 관해서 소크라테스의 명언이 생각이 나, 같이 소개 한다. <br>

<center>
**다른 사람이 쓴 책을 읽는 일로 시간을 보내라. 다른사람이 고생을 하면서 깨우치는 것을 보고 쉽게 자신을 개선시킬 수 있다.** <br>
**- 소크라테스** <br>
</center>
...
<center>
![](kaggle_notebook_guide.png){#id .class width="80%"}
</center>

### Step 2

<center>
![](kaggle_notebook_list.png){#id .class width="80%"}
</center>

### Step 3

<center>
![](kaggle_notebooks.png){#id .class width="80%"}
</center>

## 제출

<center>
![](submit_data.png){#id .class width="80%"}
</center>
...
<center>
![](create_notebook_1.PNG){#id .class width="80%"}
</center>

### Step 2

<center>
![](create_notebook_2.PNG){#id .class width="80%"}
</center>

### Step 3

<center>
![](create_notebook_3.PNG){#id .class width="80%"}
</center>

### Step 4

<center>
![](create_notebook_4.PNG){#id .class width="80%"}
</center>

### Step 5

<center>
![](create_notebook_5.PNG){#id .class width="80%"}
</center>

### Step 6

<center>
![](create_notebook_6.PNG){#id .class width="80%"}
</center>
