...
knitr::opts_chunk$set(echo = TRUE, message=FALSE, warning=FALSE,fig.width=11, fig.align = "center")
```

<p align="center">
  <img src="https://storage.googleapis.com/kaggle-competitions/kaggle/3948/media/bikes.png"> <br>
  <b>Kaggle: [Bike Sharing Demand](https://www.kaggle.com/c/bike-sharing-demand/overview)</b> <br>
